...
<head>
	<title><?=APP_NAME?> &bull; <?=$title?></title>
	<?php include Kohana::find_file('views', 'templates/default/meta'); ?>
	<link type="text/css" rel="stylesheet" href="<?=Skin::css('client/edit')?>" />
...
<body>
	...
	<div id="MidPanel" class="has-top has-bottom">
		...
		<fieldset class="ContactInfo">
			...
			<table class="form">
				<tr>
					...
					<td><?=Form::input('contact_name', @$post['contact_name'])?></td>
				</tr>
				<tr>
					<th>Phone</th>
				...
				<tr>
					<th>Status</th>
					<td>
						<label><?=Form::radio('is_active', 1, @$post['is_active'] == 1)?> <span class="status active">Active</span></label>
						<label><?=Form::radio('is_active', 0, @$post['is_active'] == 0)?> <span class="status inactive">Inactive</span></label>
					</td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset class="Notes">
			<legend>Notes</legend>
			<?=Form::textarea('notes', @$post['notes'], array('class' => 'full-width'))?>
		</fieldset>
	</div><!--#MidPanel-->
